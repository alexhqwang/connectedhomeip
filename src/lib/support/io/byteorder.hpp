...
enum {
    Unknown      = ByteOrderUnknown,
    LittleEndian = ByteOrderLittleEndian,
    BigEndian    = ByteOrderBigEndian
};

/**
 * This represents a type for a byte ordering.
 */
typedef ByteOrder_t ByteOrder;
...
{
    ByteOrderPointerSwap16(inValue);
}
...
{
    ByteOrderPointerSwap32(inValue);
}
...
{
    ByteOrderPointerSwap64(inValue);
}
...
{
    return ByteOrderSwap16LittleToHost(inValue);
}
...
{
    return ByteOrderSwap32LittleToHost(inValue);
}
...
{
    return ByteOrderSwap64LittleToHost(inValue);
}
...
{
    return ByteOrderSwap16HostToLittle(inValue);
}
...
{
    return ByteOrderSwap32HostToLittle(inValue);
}
...
{
    return ByteOrderSwap64HostToLittle(inValue);
}
...
{
    return ByteOrderSwap16BigToHost(inValue);
}
...
{
    return ByteOrderSwap32BigToHost(inValue);
}
...
{
    return ByteOrderSwap64BigToHost(inValue);
}
...
{
    return ByteOrderSwap16HostToBig(inValue);
}
...
{
    return ByteOrderSwap32HostToBig(inValue);
}
...
{
    return ByteOrderSwap64HostToBig(inValue);
}
