 ...
 */
static inline uint16_t ByteOrderSwap16LittleToHost(uint16_t inValue)
{
    return ByteOrderValueSwap16(inValue);
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint32_t ByteOrderSwap32LittleToHost(uint32_t inValue)
{
    return ByteOrderValueSwap32(inValue);
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint64_t ByteOrderSwap64LittleToHost(uint64_t inValue)
{
    return ByteOrderValueSwap64(inValue);
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint16_t ByteOrderSwap16HostToLittle(uint16_t inValue)
{
    return ByteOrderValueSwap16(inValue);
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint32_t ByteOrderSwap32HostToLittle(uint32_t inValue)
{
    return ByteOrderValueSwap32(inValue);
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint64_t ByteOrderSwap64HostToLittle(uint64_t inValue)
{
    return ByteOrderValueSwap64(inValue);
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint16_t ByteOrderSwap16BigToHost(uint16_t inValue)
{
    return inValue;
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint32_t ByteOrderSwap32BigToHost(uint32_t inValue)
{
    return inValue;
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint64_t ByteOrderSwap64BigToHost(uint64_t inValue)
{
    return inValue;
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint16_t ByteOrderSwap16HostToBig(uint16_t inValue)
{
    return inValue;
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint32_t ByteOrderSwap32HostToBig(uint32_t inValue)
{
    return inValue;
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint64_t ByteOrderSwap64HostToBig(uint64_t inValue)
{
    return inValue;
}
