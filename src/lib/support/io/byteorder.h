 ...
 * would be expected of ByteOrder.
 */

#if __IOHasBuiltin(__builtin_bswap16)
#define __BYTEORDER_BSWAP16 __builtin_bswap16
#else
#define __BYTEORDER_BSWAP16 ByteOrderConstantSwap16
#endif

#if __IOHasBuiltin(__builtin_bswap32)
#define __BYTEORDER_BSWAP32 __builtin_bswap32
#else
#define __BYTEORDER_BSWAP32 ByteOrderConstantSwap32
#endif

#if __IOHasBuiltin(__builtin_bswap64)
#define __BYTEORDER_BSWAP64 __builtin_bswap64
#else
#define __BYTEORDER_BSWAP64 ByteOrderConstantSwap64
#endif
 ...
 *
 */
#define ByteOrderConstantSwap16(c)                                 \
    ((uint16_t)                                                      \
        ((((uint16_t)(c) & (uint16_t)0x00ffU) << 8) |                \
         (((uint16_t)(c) & (uint16_t)0xff00U) >> 8)))

/**
 *  @def ByteOrderConstantSwap32
 *
 *  @brief
 *     Performs a preprocessor-compatible in place byte swap of the
 ...
 *
 */
#define ByteOrderConstantSwap32(c)                                 \
    ((uint32_t)                                                      \
 ...
 *
 */
#define ByteOrderConstantSwap64(c)                                 \
    ((uint64_t)                                                      \
...
/**
 *  @def MATTER_BYTEORDER_LITTLE_ENDIAN
 *
 *  @brief
 *     Constant preprocessor definition used to test #MATTER_BYTEORDER
 ...
 *
 */
#define MATTER_BYTEORDER_LITTLE_ENDIAN       0x1234

/**
 *  @def MATTER_BYTEORDER_BIG_ENDIAN
 *
 *  @brief
 *     Constant preprocessor definition used to test #MATTER_BYTEORDER
 ...
 *
 */
#define MATTER_BYTEORDER_BIG_ENDIAN          0x4321

/**
 *  @def MATTER_BYTEORDER_UNKNOWN_ENDIAN
 *
 *  @brief
 *     Constant preprocessor definition used to test #MATTER_BYTEORDER
 ...
 *
 *  @code
 *  #elif MATTER_BYTEORDER == MATTER_BYTEORDER_UNKNOWN_ENDIAN
 *  #error "Unknown byte ordering!"
 *  #endif
 *  @endcode
 *
 */
#define MATTER_BYTEORDER_UNKNOWN_ENDIAN      0xFFFF

/**
 *  @def MATTER_BYTEORDER
 *
 *  @brief
 *     Constant preprocessor definition containing the target system
 *     byte ordering. May be one of:
 *
 *       - MATTER_BYTEORDER_BIG_ENDIAN
 *       - MATTER_BYTEORDER_LITTLE_ENDIAN
 *       - MATTER_BYTEORDER_UNKNOWN_ENDIAN
 *
 */
#if defined(__BYTE_ORDER__)
# if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
#  define MATTER_BYTEORDER MATTER_BYTEORDER_LITTLE_ENDIAN
# elif __BYTE_ORDER__ == __ORDER_BIG_ENDIAN__
#  define MATTER_BYTEORDER MATTER_BYTEORDER_BIG_ENDIAN
...
#define MATTER_BYTEORDER MATTER_BYTEORDER_UNKNOWN_ENDIAN
#endif /* defined(__BYTE_ORDER__) */

enum {
    ByteOrderUnknown      = MATTER_BYTEORDER_UNKNOWN_ENDIAN,
    ByteOrderLittleEndian = MATTER_BYTEORDER_LITTLE_ENDIAN,
    ByteOrderBigEndian    = MATTER_BYTEORDER_BIG_ENDIAN
};

/**
 * This represents a type for a byte ordering.
 */
typedef uint16_t ByteOrder_t;
 ...
 */
static inline ByteOrder_t ByteOrderGetCurrent(void)
{
#if (MATTER_BYTEORDER == MATTER_BYTEORDER_LITTLE_ENDIAN)
 ...
 */
static inline uint16_t ByteOrderValueSwap16(uint16_t inValue)
{
    return __BYTEORDER_BSWAP16(inValue);
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint32_t ByteOrderValueSwap32(uint32_t inValue)
{
    return __BYTEORDER_BSWAP32(inValue);
}
 ...
 * @return The input value, byte order swapped.
 */
static inline uint64_t ByteOrderValueSwap64(uint64_t inValue)
{
    return __BYTEORDER_BSWAP64(inValue);
}
 ...
 *                         order swapped.
 */
static inline void ByteOrderPointerSwap16(uint16_t *inValue)
{
    *inValue = ByteOrderValueSwap16(*inValue);
}
 ...
 *                         order swapped.
 */
static inline void ByteOrderPointerSwap32(uint32_t *inValue)
{
    *inValue = ByteOrderValueSwap32(*inValue);
}
 ...
 *                         order swapped.
 */
static inline void ByteOrderPointerSwap64(uint64_t *inValue)
{
    *inValue = ByteOrderValueSwap64(*inValue);
}

#if (MATTER_BYTEORDER == MATTER_BYTEORDER_LITTLE_ENDIAN)
#include <lib/support/io/byteorder-little.h>
#elif (MATTER_BYTEORDER == MATTER_BYTEORDER_BIG_ENDIAN)
#include <lib/support/io/byteorder-big.h>
#endif /* (MATTER_BYTEORDER == MATTER_BYTEORDER_LITTLE_ENDIAN) */

#ifdef __cplusplus
}
#endif

#undef __BYTEORDER_BSWAP16
#undef __BYTEORDER_BSWAP32
#undef __BYTEORDER_BSWAP64
