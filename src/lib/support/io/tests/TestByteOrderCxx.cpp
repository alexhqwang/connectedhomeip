...
using namespace chip::ByteOrder;
...
{
    NL_TEST_ASSERT(inSuite, Unknown      == static_cast<ByteOrder>(ByteOrderUnknown));
    NL_TEST_ASSERT(inSuite, LittleEndian == static_cast<ByteOrder>(ByteOrderLittleEndian));
    NL_TEST_ASSERT(inSuite, BigEndian    == static_cast<ByteOrder>(ByteOrderBigEndian));
}
...
CHIP_REGISTER_TEST_SUITE(TestByteOrderCxx)
