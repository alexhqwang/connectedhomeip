...
#include "lib/support/io/tests/TestIoByteOrder.h"

#include <stdlib.h>
#include <unistd.h>

#include <lib/support/io/io-byteorder.hpp>
#include <lib/support/UnitTestRegistration.h>

#include <nlunit-test.h>

using namespace chip::ByteOrder;
using namespace chip::IO;
...
int TestIoByteOrderCxx(void)
{
    nlTestSuite theSuite = {
        "IO ByteOrder C++ tests",
        &sTests[0]
    };
...
CHIP_REGISTER_TEST_SUITE(TestIoByteOrderCxx)
